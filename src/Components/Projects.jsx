    ...
    <div className="">
      ...
      <div className="sm:flex justify-between  sm:p-5 p-1 sm:mb-0 mb-20 ">
        ...
        <div className=" m-auto">
          <h1 className="text-3xl sm:w-[250px] m-auto mb-8 text-purple-600 font-audiowide border-b text-center border-b-cyan-400 hover:sm:w-[270px] transition-all ">
            Clinica Medica
          </h1>
      ...
      <div className="sm:flex justify-between  sm:p-5 p-1 sm:mb-0 mb-20 ">
        <div className=" m-auto">
          <h1 className="text-3xl sm:w-[390px] hover:sm:w-[410px] transition-all m-auto mb-8 text-purple-600 font-audiowide border-b text-center border-b-cyan-400  ">
            Crypto Casino - Cubix
          </h1>
          <p className="sm:w-[600px] text-xl font-audiowide text-white ">
            It is a{" "}
